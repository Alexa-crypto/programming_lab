...
namespace LR5_2
{
    public partial class fAddPhone : Form
    {
        ...
        public fAddPhone(ref Phone phone)
        {
            this.phone = phone;
            InitializeComponent();
        }
        ...
        private void btAdd_Click(object sender, EventArgs e)
        {
            if (phone != null)
            {
                phone.operatitong_sistem = tbOc.Text;
                phone.cpu = tbCpu.Text;
                phone.gpu = tbGpu.Text;
                phone.rom = Convert.ToInt32(tbRom.Text);
                phone.ram = Convert.ToInt32(tbRam.Text);
                phone.tip_body = tbBody.Text;
                phone.camera = cbCamera.Checked;
                phone.biometrics = cbBiometrix.Checked;
